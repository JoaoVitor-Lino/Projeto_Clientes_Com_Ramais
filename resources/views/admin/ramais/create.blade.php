                ...
                <form class="form-floating" action="{{route('ramais.store')}}" method="post">
                    ...
                    <div class="col-md-6 ConteudoCard">
                        ...
                        <div class="form-floating">
                            ...
                            <input type="number" class="form-control @error('ramal') is-invalid @enderror" id="nome" name="ramal" value="{{ old('ramal') }}">
                        ...
                        <div class="form-floating">
                            ...
                            <input type="text" class="form-control @error('nome') is-invalid @enderror" id="telefone" name="nome" value=" {{old('nome') }}">
                    ...
                    <br>
                    <div class="form-floating">
                        <input type="text" class="form-control @error('bina') is-invalid @enderror" id="endereco" name="bina" value=" {{old('bina') }}">
